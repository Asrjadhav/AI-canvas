...
const GenerateImageForm = ({
  ...
  // ✅ Fixed: No base64 prefix or typo. Use direct URL from backend
  const generateImageFun = async () => {
    ...
    try {
      ...
      setPost({
        ...post,
        photo: res?.data?.photo, // ✅ Cloudinary image URL
      });
    } catch (error) {
  ...
  return (
    <Form>
      ...
      <Body>
        ...
        <small>** You can post the AI Generated Image to the Community **</small>
      </Body>
